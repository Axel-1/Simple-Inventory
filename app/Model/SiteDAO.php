...
class SiteDAO extends DAO
{
    public static function getAll(): array
    {
        ...
        foreach ($rs as $key => $val) {
            $siteCollection[$val['ID_site']] = new Site($val['ID_site'], $val['Nom_site'], $val['Adresse'], $val['Ville'], $val['CP'], MonitoringDAO::getMonitoringByID($val['ID_supervision']), ProductDAO::getProductBySiteID($val['ID_site']));
        }
    ...
    public static function getSiteByID(int $siteID): Site
    {
        ...
        return new Site($rs[0]['ID_site'], $rs[0]['Nom_site'], $rs[0]['Adresse'], $rs[0]['Ville'], $rs[0]['CP'], MonitoringDAO::getMonitoringByID($rs[0]['ID_supervision']), ProductDAO::getProductBySiteID($rs[0]['ID_site']));
    }
